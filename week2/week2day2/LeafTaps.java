...
public class LeafTaps {
	     ...
	     public static void main(String[] args) {
			...
			driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("10/10/1000");
			//CONTACT INFORMATION            
			...
			driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("gp@gmail.com");
			driver.findElement(By.id("createLeadForm_primaryWebUrl")).sendKeys("gp.com");
            //address
			driver.findElement(By.id("createLeadForm_generalToName")).sendKeys("PURUSHOTH");
			...
			driver.findElement(By.id("createLeadForm_generalAttnName")).sendKeys("gp");
			driver.findElement(By.id("createLeadForm_generalAddress2")).sendKeys("NEI");		
